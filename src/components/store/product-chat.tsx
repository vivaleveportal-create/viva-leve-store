  ...
  return (
    <>
      ...
      {showNotification && !isOpen && (
        <div 
          onClick={handleOpen}
          className="fixed bottom-[140px] left-4 right-auto sm:bottom-24 sm:right-6 sm:left-auto bg-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-2xl shadow-xl border border-viva-primary/10 flex items-center gap-2 cursor-pointer z-[60] animate-in fade-in slide-in-from-bottom-4 duration-500"
        >
      ...
      {!isOpen && (
        <button
          onClick={handleOpen}
          className="fixed bottom-20 left-4 right-auto sm:bottom-6 sm:right-6 sm:left-auto bg-viva-primary text-white rounded-full w-12 h-12 sm:w-14 sm:h-14 shadow-xl flex items-center justify-center z-[60] hover:scale-105 transition-transform duration-300"
        >
